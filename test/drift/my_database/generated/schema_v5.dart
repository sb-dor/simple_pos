...
class CategoryTable extends Table
    with TableInfo<CategoryTable, CategoryTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class CategoryTableData extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, establishmentId, name, updatedAt, colorValue, changed);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class ProductsCategoriesTable extends Table
    with TableInfo<ProductsCategoriesTable, ProductsCategoriesTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ProductsCategoriesTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'products_categories_table';
  @override
  Set<GeneratedColumn> get $primaryKey => const {};
  @override
  ProductsCategoriesTableData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProductsCategoriesTableData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  ProductsCategoriesTable createAlias(String alias) {
    return ProductsCategoriesTable(attachedDatabase, alias);
  }
}

class ProductsCategoriesTableData extends DataClass
    implements Insertable<ProductsCategoriesTableData> {
  final String id;
  final String? productId;
  final String? categoryId;
  const ProductsCategoriesTableData({
    required this.id,
    this.productId,
    this.categoryId,
  });
  ...
  ProductsCategoriesTableCompanion toCompanion(bool nullToAbsent) {
    return ProductsCategoriesTableCompanion(
      id: Value(id),
      productId: productId == null && nullToAbsent
          ? const Value.absent()
          : Value(productId),
  ...
  factory ProductsCategoriesTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ProductsCategoriesTableData copyWith({
    String? id,
    Value<String?> productId = const Value.absent(),
    Value<String?> categoryId = const Value.absent(),
  }) => ProductsCategoriesTableData(
    id: id ?? this.id,
    productId: productId.present ? productId.value : this.productId,
    categoryId: categoryId.present ? categoryId.value : this.categoryId,
  );
  ProductsCategoriesTableData copyWithCompanion(
    ProductsCategoriesTableCompanion data,
  ) {
    return ProductsCategoriesTableData(
      id: data.id.present ? data.id.value : this.id,
      productId: data.productId.present ? data.productId.value : this.productId,
  ...
  @override
  String toString() {
    return (StringBuffer('ProductsCategoriesTableData(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProductsCategoriesTableData &&
          other.id == this.id &&
          other.productId == this.productId &&
          other.categoryId == this.categoryId);
}

class ProductsCategoriesTableCompanion
    extends UpdateCompanion<ProductsCategoriesTableData> {
  final Value<String> id;
  final Value<String?> productId;
  final Value<String?> categoryId;
  final Value<int> rowid;
  const ProductsCategoriesTableCompanion({
    this.id = const Value.absent(),
    this.productId = const Value.absent(),
    this.categoryId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ProductsCategoriesTableCompanion.insert({
    required String id,
    this.productId = const Value.absent(),
    this.categoryId = const Value.absent(),
    this.rowid = const Value.absent(),
  }) : id = Value(id);
  static Insertable<ProductsCategoriesTableData> custom({
    Expression<String>? id,
  ...
  ProductsCategoriesTableCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('ProductsCategoriesTableCompanion(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('categoryId: $categoryId, ')
          ..write('rowid: $rowid')
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final CategoryTable categoryTable = CategoryTable(this);
  late final ProductsCategoriesTable productsCategoriesTable =
      ProductsCategoriesTable(this);
  @override
