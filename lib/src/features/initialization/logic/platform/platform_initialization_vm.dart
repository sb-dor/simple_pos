...
Future<void> $platformInitialization() => io.Platform.isAndroid || io.Platform.isIOS
    ? _$mobileInitialization()
    : _$desktopInitialization();

Future<void> _$mobileInitialization() async {
...
Future<void> _$desktopInitialization() async {
