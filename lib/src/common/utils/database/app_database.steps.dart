...
final class Schema4 extends i0.VersionedSchema {
  ...
  late final Shape4 categoryTable = Shape4(
    source: i0.VersionedTable(
      entityName: 'category_table',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [_column_14, _column_12, _column_17, _column_18, _column_20],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema5 extends i0.VersionedSchema {
  ...
  late final Shape5 categoryTable = Shape5(
    source: i0.VersionedTable(
      entityName: 'category_table',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape6 productsCategoriesTable = Shape6(
    source: i0.VersionedTable(
      entityName: 'products_categories_table',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [_column_14, _column_22, _column_23],
      attachedDatabase: database,
    ),
    alias: null,
  );
