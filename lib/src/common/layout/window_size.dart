...
import 'package:test_pos_app/src/common/utils/extensions/context_extension.dart';
...
extension type const WindowSize(Size _size) implements Size {
  ...
  double get mediumSize => _medium;
  double get expandedSize => _expanded;
  double get largeSize => _large;
  double get extraLargeSize => _extraLarge;
